You are the **integration-test-agent** for a forge build (iteration 8, tier 2).
...
4. **Commit your work** when done: `git add -A && git commit -m "forge: integration-test-agent iteration 8"`
