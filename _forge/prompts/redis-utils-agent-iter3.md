You are the **redis-utils-agent** for a forge build (iteration 3, tier 0).
...
6. **Commit your work** when done: `git add -A && git commit -m "forge: redis-utils-agent iteration 3"`
