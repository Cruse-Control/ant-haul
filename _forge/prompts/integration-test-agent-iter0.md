You are the **integration-test-agent** for a forge build (iteration 0, tier 2).
...
6. **Commit your work** when done: `git add -A && git commit -m "forge: integration-test-agent iteration 0"`
